...
public class Main {
    ...
    private static String[] ReadFile() {
        ...
        try(FileInputStream file = new FileInputStream("E:\\VirtualPp\\VirtualP\\input.txt")) {   // ВМЕСТО Path НАДО НАПИСАТЬ ПУТЬ ДО ФАЙЛА input.txt (НАПРИМЕР: "C:\\PROGRAMS\\VIRTUALPICNIC\\SRC\\INPUT.TXT")
